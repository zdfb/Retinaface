...
class FPN(nn.Module):
    def __init__(self, in_channels_list, out_channels):
        ...
        self.output4_1 = conv_bn(out_channels, out_channels, leaky = leaky)
        self.output5 = conv_bn(in_channels_list[3], out_channels, stride = 2, leaky = leaky)
    ...
    def forward(self, input):
        ...
        output4 = self.output4_1(output4)
